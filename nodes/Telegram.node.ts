...
export class Telegram implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Telegram (with Proxy)',
		name: 'telegramProxy',
		icon: 'file:telegram.svg',
		group: ['output'],
		version: [1, 1.1, 1.2],
		subtitle: '={{$parameter["operation"] + ": " + $parameter["resource"]}}',
		description: 'Sends data to Telegram with proxy support',
		defaults: {
		...
		properties: [
			...
			},
			{
				...
				options: [
					{ name: 'Get', value: 'get', description: 'Get up to date information about a chat', action: 'Get a chat' },
					{ name: 'Get Administrators', value: 'administrators', description: 'Get the Administrators of a chat', action: 'Get all administrators in a chat' },
					{ name: 'Get Member', value: 'member', description: 'Get the member of a chat', action: 'Get a member in a chat' },
					{ name: 'Leave', value: 'leave', description: 'Leave a group, supergroup or channel', action: 'Leave a chat' },
					{ name: 'Set Description', value: 'setDescription', description: 'Set the description of a chat', action: 'Set description on a chat' },
					{ name: 'Set Title', value: 'setTitle', description: 'Set the title of a chat', action: 'Set a title on a chat' },
				],
				default: 'get',
			},
			{
				...
				options: [
					{ name: 'Answer Query', value: 'answerQuery', description: 'Send answer to callback query sent from inline keyboard', action: 'Answer Query a callback' },
					{ name: 'Answer Inline Query', value: 'answerInlineQuery', description: 'Send answer to callback query sent from inline bot', action: 'Answer an inline query callback' },
				],
				default: 'answerQuery',
			},
			{
			...
			},
			{
				...
				options: [
					{ name: 'Delete Chat Message', value: 'deleteMessage', description: 'Delete a chat message', action: 'Delete a chat message' },
					{ name: 'Edit Message Text', value: 'editMessageText', description: 'Edit a text message', action: 'Edit a text message' },
					{ name: 'Pin Chat Message', value: 'pinChatMessage', description: 'Pin a chat message', action: 'Pin a chat message' },
					{ name: 'Send Animation', value: 'sendAnimation', description: 'Send an animated file', action: 'Send an animated file' },
					{ name: 'Send Audio', value: 'sendAudio', description: 'Send a audio file', action: 'Send an audio file' },
					...
					{ name: 'Send Media Group', value: 'sendMediaGroup', description: 'Send group of photos or videos to album', action: 'Send a media group message' },
					{ name: 'Send Message', value: 'sendMessage', description: 'Send a text message', action: 'Send a text message' },
					{ name: 'Send Photo', value: 'sendPhoto', description: 'Send a photo', action: 'Send a photo message' },
			...
			},
			{
				...
				displayOptions: {
					show: {
						operation: ['administrators', 'deleteMessage', 'get', 'leave', 'member', 'pinChatMessage', 'setDescription', 'setTitle', 'sendAnimation', 'sendAudio', 'sendChatAction', 'sendDocument', 'sendLocation', 'sendMessage', 'sendMediaGroup', 'sendPhoto', 'sendSticker', 'sendVideo', 'unpinChatMessage'],
			...
			},
			{
				...
				default: {},
				options: [
					{ displayName: 'Cache Time', name: 'cache_time', type: 'number', typeOptions: { minValue: 0 }, default: 0, description: 'The maximum amount of time in seconds that the result of the callback query may be cached client-side' },
					{ displayName: 'Show Alert', name: 'show_alert', type: 'boolean', default: false, description: 'Whether an alert will be shown by the client instead of a notification at the top of the chat screen' },
					{ displayName: 'Text', name: 'text', type: 'string', default: '', description: 'Text of the notification. If not specified, nothing will be shown to the user, 0-200 characters.' },
					{ displayName: 'URL', name: 'url', type: 'string', default: '', description: "URL that will be opened by the user's client" },
				],
			},
			{
				displayName: 'Query ID',
			...
			},
			{
				...
				type: 'collection',
				placeholder: 'Add Field',
				displayOptions: { show: { operation: ['get'], resource: ['file'], download: [true] } },
				default: {},
				options: [
					{ displayName: 'MIME Type', name: 'mimeType', type: 'string', placeholder: 'image/jpeg', default: '', description: 'The MIME type of the file. If not specified, the MIME type will be determined by the file extension.' },
				],
			},
			{
				...
				options: [{ name: 'Inline Message', value: 'inlineMessage' }, { name: 'Message', value: 'message' }],
				default: 'message',
			...
			},
			{
				...
				displayOptions: { show: { operation: ['editMessageText'], resource: ['message'] } },
				type: 'options',
				options: [{ name: 'None', value: 'none' }, { name: 'Inline Keyboard', value: 'inlineKeyboard' }],
				default: 'none',
						...
						values: [
							{
								...
								name: 'type',
								type: 'options',
								options: [{ name: 'Photo', value: 'photo' }, { name: 'Video', value: 'video' }],
								default: 'photo',
							...
							},
							{
								...
								default: {},
								options: [
									{ displayName: 'Caption', name: 'caption', type: 'string', default: '', description: 'Caption text to set, 0-1024 characters' },
									{
										displayName: 'Parse Mode',
										name: 'parse_mode',
										type: 'options',
										options: [{ name: 'Markdown (Legacy)', value: 'Markdown' }, { name: 'MarkdownV2', value: 'MarkdownV2' }, { name: 'HTML', value: 'HTML' }],
										default: 'HTML',
			...
			},
			{
				...
				description: 'Video file to send. Pass a file_id to send a file that exists on the Telegram servers (recommended), an HTTP URL for Telegram to get a video from the Internet.',
			},
			{
				displayName: 'Reply Markup',
				name: 'replyMarkup',
				...
				type: 'options',
				options: [{ name: 'Force Reply', value: 'forceReply' }, { name: 'Inline Keyboard', value: 'inlineKeyboard' }, { name: 'None', value: 'none' }, { name: 'Reply Keyboard', value: 'replyKeyboard' }, { name: 'Reply Keyboard Remove', value: 'replyKeyboardRemove' }],
				default: 'none',
				description: 'Additional interface options',
			},
			{
				...
				default: {},
				options: [
					{ displayName: 'Force Reply', name: 'force_reply', type: 'boolean', default: false, description: 'Whether to show reply interface to the user' },
					{ displayName: 'Selective', name: 'selective', type: 'boolean', default: false, description: 'Whether to force reply from specific users only' },
				],
			},
			{
								...
								options: [
									{
										...
										name: 'buttons',
										values: [
											{ displayName: 'Text', name: 'text', type: 'string', default: '', description: 'Label text on the button' },
											{
												displayName: 'Additional Fields',
												name: 'additionalFields',
												type: 'collection',
												...
												default: {},
												options: [
													{ displayName: 'Callback Data', name: 'callback_data', type: 'string', default: '', description: 'Data to be sent in a callback query' },
													{ displayName: 'URL', name: 'url', type: 'string', default: '', description: 'HTTP or tg:// URL to be opened when button is pressed' },
												],
											},
										],
									},
								...
								options: [
									{
										...
										name: 'buttons',
										values: [
											{ displayName: 'Text', name: 'text', type: 'string', default: '', description: 'Text of the button' },
											{
												displayName: 'Additional Fields',
												name: 'additionalFields',
												type: 'collection',
												...
												default: {},
												options: [
													{ displayName: 'Request Contact', name: 'request_contact', type: 'boolean', default: false, description: 'Whether the users phone number will be sent' },
													{ displayName: 'Request Location', name: 'request_location', type: 'boolean', default: false, description: 'Whether the users request_location' },
												],
											},
										],
									},
			...
			},
			{
				...
				default: {},
				options: [
					{ displayName: 'Resize Keyboard', name: 'resize_keyboard', type: 'boolean', default: false, description: 'Whether to request clients to resize the keyboard vertically for optimal fit' },
					{ displayName: 'One Time Keyboard', name: 'one_time_keyboard', type: 'boolean', default: false, description: 'Whether to request clients to hide the keyboard as soon as it has been used' },
					{ displayName: 'Selective', name: 'selective', type: 'boolean', default: false, description: 'Whether to show the keyboard to specific users only' },
				],
			},
			{
				...
				default: {},
				options: [
					{ displayName: 'Remove Keyboard', name: 'remove_keyboard', type: 'boolean', default: false, description: 'Whether to request clients to remove the custom keyboard' },
					{ displayName: 'Selective', name: 'selective', type: 'boolean', default: false, description: 'Whether to force reply from specific users only' },
				],
			},
			{
				...
				displayOptions: {
					show: {
						operation: ['editMessageText', 'sendAnimation', 'sendAudio', 'sendDocument', 'sendLocation', 'sendMessage', 'sendMediaGroup', 'sendPhoto', 'sendSticker', 'sendVideo'],
						resource: ['message'],
					},
				},
				default: {},
				options: [
					{ displayName: 'Append Attribution', name: 'appendAttribution', type: 'boolean', default: true, description: 'Whether to include the attribution message', displayOptions: { show: { '/operation': ['sendMessage'] } } },
					{ displayName: 'Caption', name: 'caption', type: 'string', displayOptions: { show: { '/operation': ['sendAnimation', 'sendAudio', 'sendDocument', 'sendPhoto', 'sendVideo'] } }, default: '', description: 'Caption text to set, 0-1024 characters' },
					{ displayName: 'Disable Notification', name: 'disable_notification', type: 'boolean', default: false, displayOptions: { hide: { '/operation': ['editMessageText'] } }, description: 'Whether to send the message silently' },
					{ displayName: 'Disable WebPage Preview', name: 'disable_web_page_preview', type: 'boolean', displayOptions: { show: { '/operation': ['editMessageText', 'sendMessage'] } }, default: false, description: 'Whether to disable link previews for links in this message' },
					{ displayName: 'Duration', name: 'duration', type: 'number', typeOptions: { minValue: 0 }, displayOptions: { show: { '/operation': ['sendAnimation', 'sendAudio', 'sendVideo'] } }, default: 0, description: 'Duration of clip in seconds' },
					{ displayName: 'File Name', name: 'fileName', type: 'string', default: '', displayOptions: { show: { '/operation': ['sendAnimation', 'sendAudio', 'sendDocument', 'sendPhoto', 'sendVideo', 'sendSticker'], '/resource': ['message'], '/binaryData': [true] } }, placeholder: 'image.jpeg' },
					{ displayName: 'Height', name: 'height', type: 'number', typeOptions: { minValue: 0 }, displayOptions: { show: { '/operation': ['sendAnimation', 'sendVideo'] } }, default: 0, description: 'Height of the video' },
					{
						displayName: 'Parse Mode',
						name: 'parse_mode',
						type: 'options',
					...
					{ displayName: 'Performer', name: 'performer', type: 'string', displayOptions: { show: { '/operation': ['sendAudio'] } }, default: '', description: 'Name of the performer' },
					{ displayName: 'Reply To Message ID', name: 'reply_to_message_id', type: 'number', displayOptions: { hide: { '/operation': ['editMessageText'] } }, default: 0, description: 'If the message is a reply, ID of the original message' },
					{ displayName: 'Message Thread ID', name: 'message_thread_id', type: 'number', displayOptions: { show: { '/operation': ['sendAnimation', 'sendAudio', 'sendChatAction', 'sendDocument', 'sendLocation', 'sendMediaGroup', 'sendMessage', 'sendPhoto', 'sendSticker', 'sendVideo'] } }, default: 0, description: 'The unique identifier of the forum topic' },
					{ displayName: 'Title', name: 'title', type: 'string', displayOptions: { show: { '/operation': ['sendAudio'] } }, default: '', description: 'Title of the track' },
					{ displayName: 'Thumbnail', name: 'thumb', type: 'string', displayOptions: { show: { '/operation': ['sendAnimation', 'sendAudio', 'sendDocument', 'sendVideo'] } }, default: '', description: 'Thumbnail of the file sent' },
					{ displayName: 'Width', name: 'width', type: 'number', typeOptions: { minValue: 0 }, displayOptions: { show: { '/operation': ['sendAnimation', 'sendVideo'] } }, default: 0, description: 'Width of the video' },
				],
			},
		],
	};
		...
		for (let i = 0; i < items.length; i++) {
			try {
				...
				if (binaryData) {
					...
					if (!fileName && !itemBinaryData.fileName) {
						throw new NodeOperationError(
							this.getNode(),
							`File name is needed for ${operation}. Set it in the node using the File Name parameter under Additional Fields.`,
						);
					}
					...
					const formData = {
						...
						[propertyName]: {
							value: uploadData,
							options: { filename, contentType: itemBinaryData.mimeType },
						},
					};
				...
				if (resource === 'file' && operation === 'get') {
					if (this.getNodeParameter('download', i, false)) {
						...
						const file = await apiRequest.call(
							...
							{},
							{},
							{ json: false, encoding: null, uri: `${credentials.baseUrl}/file/bot${credentials.accessToken}/${filePath}`, resolveWithFullResponse: true, useStream: true },
						);
						...
						const data = await this.helpers.prepareBinaryData(file.body as Buffer, fileName, mimeType);

						returnData.push({ json: responseData, binary: { data }, pairedItem: { item: i } });
						continue;
					}
				} else if (resource === 'chat' && operation === 'administrators') {
					const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData.result as IDataObject[]), { itemData: { item: i } });
				...
				if (this.continueOnFail()) {
					const executionErrorData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray({ error: error.description ?? error.message }), { itemData: { item: i } });
